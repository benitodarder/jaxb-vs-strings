 ...
 * @author benitodarder
 */
public class StringBufferProcessor extends RegexExtractorProcessor {

    public static final String OUTPUT_FILENAME_SUFFIX = "StringBufferProcessor";
    
    public StringBufferProcessor(int index, String sampleFileName, String outputPath) {
